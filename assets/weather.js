const apikey="04a44d65218d0d88e5546f8aebf45804";
...
function weatherReport(data){
    ...
    fetch(urlcast).then((res)=>{
       ...
       document.getElementById('clouds').innerText = condition;

    //    data.weather[0].description;  document.getElementById('clouds').innerText= data.weather[0].description;
        // console.log(data.weather[0].description)
        console.log(condition);
        document.getElementById('#123').innerHTML = condition;
...
// app.get("/", function (req, res) {
    // res.sendFile(__dirname+"/weatherApp/weather.html");
// });
// 
